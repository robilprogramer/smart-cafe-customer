...
export default function PenggunaPage() {
  ...
  const handleDelete = useCallback((email: string, nama: string) => {
    if (currentUserRole !== "superadmin") {
      toast.error("Anda tidak memiliki akses untuk menghapus pengguna!", { position: "top-right" });
      return;
    }
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="overflow-x-auto">
            ...
            {users.length === 0 && (
              <p className="text-center text-gray-500 mt-4">Belum ada pengguna terdaftar.</p>
            )}
          </div>
        </div>
      </div>
